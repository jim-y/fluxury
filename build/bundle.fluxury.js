...
},{"./components/welcomeComponent.jsx":2,"react":147}],2:[function(require,module,exports){
/** @jsx React.DOM */
/* jshint -W097 */
'use strict';
...
var React = require('react'),
    ...
    Mycomponent = React.createClass({displayName: 'Mycomponent',
      render: function() {
        return (
            React.DOM.h1({className: "Mycomponent"}, "Welcome to fluxury")
            )
      }
    });
